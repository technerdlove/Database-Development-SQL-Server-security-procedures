...
If these have not already been created in ITC 226, create a schema for every Position. There should also be a role for every position. Create at least one view for every schema that would represent a typical perspective on the data for employees who hold that position. 
